                        ...
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" value="utente@esempio.com" disabled>
                                </div>
                                <div class="mb-3">
                                    <label for="profession" class="form-label">Professione</label>
                                    <input type="text" class="form-control" id="profession" value="Sviluppatore Web" disabled>
                                </div>
                                <div class="mb-3">
